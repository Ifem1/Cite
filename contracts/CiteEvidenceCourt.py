...
class CiteEvidenceCourt(gl.Contract):
    ...
    # ==================================================================
    # Internal helpers — private, no type annotations on return values
    # that GenLayer cannot map to a wire type
    # ==================================================================
    ...
    def _safe_int(self, v: typing.Any, default: int) -> int:
        try:
            return int(v)
        except Exception:
            return default
    ...
    def _normalise_ai_verdict(self, raw: typing.Any) -> typing.Any:
        ...
        strongest_evidence_id = self._safe_int(parsed.get("strongest_evidence_id", 0), 0)
        weakest_evidence_id = self._safe_int(parsed.get("weakest_evidence_id", 0), 0)
    ...
    def _run_consensus_review(self, claim: typing.Any, evidence_packet: str) -> typing.Any:
...
""",
    ...
    # ==================================================================
    # Read methods — all return str (JSON) so the schema stays simple
    # ==================================================================
